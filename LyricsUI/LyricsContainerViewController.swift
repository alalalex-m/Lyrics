...
private extension LyricsContainerViewController {
    ...
    func _presentMoreActionsViewController() {
        ...
        let actions = [
            ...
            UIAlertAction(title: localized("followOnIG"), style: .default) { _ in
                UIApplication.shared.open(URL(string: "https://www.instagram.com/alalalex_m")!)
            },
            UIAlertAction(title: localized("followOnGitHub"), style: .default) { _ in
                UIApplication.shared.open(URL(string: "https://github.com/https://github.com/alalalex-m")!)
            },
